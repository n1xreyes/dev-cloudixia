...
describe('ListingApprovalComponent,', () => {
  ...
  describe('with a listing,', () => {
    ...
    it('should show two pending listings', () => {
      let twoMockListings: Listing[] = Object.assign([], mockListings)
    ...
    it('should show all the features of the listing', () => {
      ...
      expect(textInserts[2].innerText).toEqual("Price: " + mockListings[0].price)
      expect(textInserts[3].innerText).toEqual("Owner: " + mockListings[0].userId)
    })
